...
💬
8.81 /M
NomNom by @Itachi-1824
⚠️ ALPHA
nomnom
🧠
🔍
—
Polly by @Itachi-1824
NEW
⚠️ ALPHA
polly
👁️
  ...
  "components": {
    "securitySchemes": {
      "bearerAuth": {
        ...
        "description": "API key from [enter.pollinations.ai](https://enter.pollinations.ai)"
      }
    },
    "schemas": {
      "ErrorDetails": {
      ...
      "CreateSpeechRequest": {
        ...
        "properties": {
          ...
          "speed": {
            "default": 1,
            "description": "The speed of the generated audio. 0.25 to 4.0, default 1.0.",
            "example": 1,
            "type": "number",
            "minimum": 0.25,
            "maximum": 4
          ...
          "instrumental": {
            "description": "If true, guarantees instrumental output (elevenmusic only)",
            "example": false,
            "type": "boolean"
          }
        },
  ...
  "paths": {
    "/account/profile": {
      "get": {
        ...
        "summary": "Get Profile",
        "description": "Returns your account profile including name, email, tier level, and account creation date. Requires `account:profile` permission when using API keys.",
        "responses": {
          "200": {
          ...
          "403": {
            "description": "Permission denied - API key missing `account:profile` permission"
          }
        },
        "x-codeSamples": [
          {
    ...
    "/account/balance": {
      "get": {
        ...
        "summary": "Get Balance",
        "description": "Returns your current pollen balance. If the API key has a budget limit, returns the key's remaining budget instead. Requires `account:balance` permission when using API keys.",
        "responses": {
          "200": {
          ...
          "403": {
            "description": "Permission denied - API key missing `account:balance` permission"
          }
        },
        "x-codeSamples": [
          {
    ...
    "/account/usage": {
      "get": {
        ...
        "description": "Returns your request history with per-request details: model used, token counts, cost, and response time. Supports JSON and CSV export. Use `before` for cursor-based pagination. Requires `account:usage` permission when using API keys.",
        "responses": {
          "200": {
          ...
          "403": {
            "description": "Permission denied - API key missing `account:usage` permission"
          }
        },
        "parameters": [
          {
    ...
    "/account/usage/daily": {
      "get": {
        ...
        "description": "Returns daily aggregated usage for the last 90 days, grouped by date and model. Useful for dashboards and spending analysis. Supports JSON and CSV export. Results are cached for 1 hour. Requires `account:usage` permission when using API keys.",
        "responses": {
          "200": {
                ...
                "schema": {
                  ...
                  "properties": {
                    ...
                    "expiresAt": {
                      ...
                      "description": "Expiry timestamp in ISO 8601 format, null if never expires"
                    },
                    "expiresIn": {
                      "anyOf": [
                        {
                      ...
                      "description": "Seconds until expiry, null if never expires"
                    },
                    "permissions": {
                      "type": "object",
                      "properties": {
                        "models": {
                          ...
                          "description": "List of allowed model IDs, null = all models allowed"
                        },
                        "account": {
                          "anyOf": [
                            {
                          ...
                          "description": "List of account permissions, null = no account access"
                        }
                      },
                      "required": [
                        "models",
                    ...
                    "pollenBudget": {
                      ...
                      "description": "Remaining pollen budget for this key, null = unlimited (uses user balance)"
                    },
                    "rateLimitEnabled": {
                      "type": "boolean",
    ...
    "/v1/models": {
      "get": {
        ...
        "responses": {
          ...
          "500": {
            "description": "Oh snap, something went wrong on our end. We're on it!",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                      ...
                      "properties": {
                        ...
                        "message": {
                          "anyOf": [
                            {
                              "type": "string",
                              "const": "Oh snap, something went wrong on our end. We're on it!"
                            },
                            {
                              "type": "string"
                            }
    ...
    "/image/models": {
      "get": {
        "operationId": "getGenerateImageModels",
        "tags": [
          "🤖 Models"
        ],
    ...
    "/text/models": {
      "get": {
        "operationId": "getGenerateTextModels",
        "tags": [
          "🤖 Models"
        ],
        "summary": "List Text Models (Detailed)",
        "description": "Returns all available text generation models with pricing, capabilities, and metadata including context window size, supported modalities, and tool support. When authenticated: models are filtered by API key permissions, and `paid_only` models are hidden if the account has no paid balance.",
        "responses": {
          "200": {
            "description": "Success",
            "content": {
    ...
    "/audio/models": {
      "get": {
        "operationId": "getGenerateAudioModels",
        "tags": [
          "🤖 Models"
        ],
        "summary": "List Audio Models",
        "description": "Returns all available audio models (text-to-speech, music generation, and transcription) with pricing, capabilities, and metadata. When authenticated: models are filtered by API key permissions, and `paid_only` models are hidden if the account has no paid balance.",
        "responses": {
          "200": {
            "description": "Success",
            "content": {
    ...
    "/v1/chat/completions": {
      "post": {
        "operationId": "postGenerateV1ChatCompletions",
        "tags": [
          "✍️ Text Generation"
        ],
        ...
        "responses": {
          ...
          "400": {
            "description": "Something was wrong with the input data, check the details for more info.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                      ...
                      "properties": {
                        ...
                        "message": {
                          "anyOf": [
                            {
                              "type": "string",
                              "const": "Something was wrong with the input data, check the details for more info."
                            },
                            {
                              "type": "string"
                            }
          ...
          "401": {
            "description": "Authentication required. Please provide an API key via Authorization header (Bearer token) or ?key= query parameter.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                      ...
                      "properties": {
                        ...
                        "message": {
                          "anyOf": [
                            {
                              "type": "string",
                              "const": "Authentication required. Please provide an API key via Authorization header (Bearer token) or ?key= query parameter."
                            },
                            {
                              "type": "string"
                            }
          ...
          "402": {
            "description": "Insufficient pollen balance or API key budget exhausted.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                      ...
                      "properties": {
                        ...
                        "message": {
                          "anyOf": [
                            {
                              "type": "string",
                              "const": "Insufficient pollen balance or API key budget exhausted."
                            },
                            {
                              "type": "string"
                            }
          ...
          "403": {
            "description": "Access denied! You don't have the required permissions for this resource or model.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                      ...
                      "properties": {
                        ...
                        "message": {
                          "anyOf": [
                            {
                              "type": "string",
                              "const": "Access denied! You don't have the required permissions for this resource or model."
                            },
                            {
                              "type": "string"
                            }
          ...
          "429": {
            "description": "You're making requests too quickly. Please slow down a bit.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                      ...
                      "properties": {
                        ...
                        "message": {
                          "anyOf": [
                            {
                              "type": "string",
                              "const": "You're making requests too quickly. Please slow down a bit."
                            },
                            {
                              "type": "string"
                            }
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "model": {
                    "default": "openai",
                    "description": "AI model for text generation. See /v1/models for full list.",
                    "type": "string"
                  },
                  "modalities": {
                    "type": "array",
    ...
    "/text/{prompt}": {
      "get": {
        "operationId": "getGenerateTextByPrompt",
        "tags": [
          "✍️ Text Generation"
        ],
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Text model to use. See /v1/models or /text/models for the full list of available models."
          },
          {
            "in": "query",
            "name": "seed",
          ...
          },
          {
            ...
            "description": "System prompt to set the model's behavior and context. Acts as initial instructions before the user prompt."
          },
          {
            "in": "query",
            "name": "json",
            ...
            "description": "When true, the model returns valid JSON. Useful for structured data extraction."
          },
          {
            "in": "query",
            "name": "temperature",
            ...
            "description": "Controls randomness. Lower values (e.g. 0.2) produce more focused output, higher values (e.g. 1.5) produce more creative output. Range: 0.0 to 2.0."
          },
          {
            "in": "query",
            "name": "stream",
            ...
            "description": "Stream the response as it's generated, using Server-Sent Events (SSE). Each chunk contains partial text."
          }
        ],
        "x-codeSamples": [
          {
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Model to use. **Image:** flux, zimage, gptimage, kontext, seedream5, nanobanana, nanobanana-pro, klein, klein-large, imagen-4, grok-imagine. **Video:** veo, seedance, seedance-pro, wan, ltx-2, grok-video. See /image/models for full list."
          },
          {
            "in": "query",
            "name": "width",
            ...
            "description": "Width in pixels. For images, exact pixels. For video models, mapped to nearest resolution tier (480p/720p/1080p)."
          },
          {
            "in": "query",
            "name": "height",
            ...
            "description": "Height in pixels. For images, exact pixels. For video models, mapped to nearest resolution tier (480p/720p/1080p)."
          },
          {
            "in": "query",
            "name": "seed",
            ...
            "description": "Seed for reproducible results. Use -1 for random. Supported by: flux, zimage, seedream, klein, seedance. Other models ignore this parameter."
          },
          {
            "in": "query",
            "name": "enhance",
            ...
            "description": "Let AI improve your prompt for better results. Applied during prompt processing."
          },
          {
            "in": "query",
            ...
            "description": "What to avoid in the generated image. Only supported by `flux` and `zimage` — other models ignore this."
          },
          {
            "in": "query",
            "name": "safe",
            ...
            "description": "Enable safety content filters"
          },
          {
            "in": "query",
            "name": "quality",
            ...
            "description": "Image quality level. Only supported by `gptimage` and `gptimage-large`."
          },
          {
            "in": "query",
            "name": "image",
            ...
            "description": "Reference image URL(s) for image editing or video generation. Separate multiple URLs with `|` or `,`. **Image models:** Used for editing/style reference (kontext, gptimage, seedream, klein, nanobanana). **Video models:** First image = starting frame; second image = ending frame for interpolation (veo only)."
          },
          {
            "in": "query",
            "name": "transparent",
            ...
            "description": "Generate image with transparent background. Only supported by `gptimage` and `gptimage-large`."
          },
          {
            "in": "query",
            "name": "duration",
            ...
            "description": "Video duration in seconds. Only applies to video models. `veo`: 4, 6, or 8s. `seedance`: 2-10s. `wan`: 2-15s. `ltx-2`: up to ~10s."
          },
          {
            "in": "query",
            "name": "aspectRatio",
            ...
            "description": "Video aspect ratio (`16:9` or `9:16`). Only applies to video models. If not set, determined by width/height."
          },
          {
            "in": "query",
            "name": "audio",
            ...
            "description": "Generate audio for the video. Only applies to video models. Note: `wan` and `ltx-2` generate audio regardless of this flag. For `veo`, set to `true` to enable audio."
          }
        ],
        "x-codeSamples": [
          {
    ...
    "/video/{prompt}": {
      "get": {
        "operationId": "getGenerateVideoByPrompt",
        "tags": [
          "🎬 Video Generation"
        ],
        ...
        "parameters": [
          {
            ...
            "required": true,
            "description": "Text to convert to speech, or a music description when model=elevenmusic"
          },
          {
            "in": "query",
            "name": "voice",
          ...
          },
          {
            ...
            "description": "Audio model: TTS (default) or elevenmusic for music generation"
          },
          {
            "in": "query",
            "name": "duration",
    ...
    "/v1/audio/speech": {
      "post": {
        "operationId": "postGenerateV1AudioSpeech",
        "tags": [
          "🔊 Audio Generation"
        ],
        "summary": "Text to Speech (OpenAI-compatible)",
        "description": "Generate speech or music from text. Compatible with the OpenAI TTS API — use any OpenAI SDK.\n\nSet `model` to `elevenmusic` to generate music instead of speech.\n\n**Available voices:** alloy, echo, fable, onyx, nova, shimmer, ash, ballad, coral, sage, verse, rachel, domi, bella, elli, charlotte, dorothy, sarah, emily, lily, matilda, adam, antoni, arnold, josh, sam, daniel, charlie, james, fin, callum, liam, george, brian, bill\n\n**Output formats:** mp3 (default), opus, aac, flac, wav, pcm",
        "responses": {
          "200": {
            "description": "Success - Returns audio data",
            "content": {
    ...
    "/v1/audio/transcriptions": {
      "post": {
        "operationId": "postGenerateV1AudioTranscriptions",
        "tags": [
          "🔊 Audio Generation"
        ],
              ...
              "schema": {
                ...
                "properties": {
                  ...
                  "model": {
                    ...
                    "description": "The model to use. Options: `whisper-large-v3`, `whisper-1`, `scribe`."
                  },
                  "language": {
                    "type": "string",
                    "description": "Language of the audio in ISO-639-1 format (e.g. `en`, `fr`). Improves accuracy."
                  },
                  "prompt": {
                    "type": "string",
    ...
    "/{hash}": {
      ...
      "head": {
        ...
        "responses": {
          "200": {
            "description": "File exists (headers include Content-Type, Content-Length, X-Content-Hash)"
          },
          "400": {
            "description": "Invalid hash format"
          },
      ...
      "delete": {
        "operationId": "deleteByHash",
        "tags": [
          "📦 Media Storage"
        ],
        "summary": "Delete media",
        "description": "Delete a file by its content hash. Only the original uploader can delete their own files.",
        "responses": {
          "200": {
