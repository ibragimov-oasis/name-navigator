    ...
    <div className="min-h-screen bg-background pb-28 sm:pb-12">
      ...
      <div className="container mx-auto max-w-3xl px-3 sm:px-4 py-4 sm:py-8">
        <div className="text-center mb-6 sm:mb-8">
          <Crown className="mx-auto h-8 w-8 sm:h-10 sm:w-10 text-primary" />
          <h1 className="mt-2.5 font-display text-2xl sm:text-3xl font-bold text-foreground">Пророки и сахабы</h1>
          <p className="mt-1 text-xs sm:text-sm text-muted-foreground">Имена пророков, сподвижников и семьи Пророка ﷺ</p>
        </div>
