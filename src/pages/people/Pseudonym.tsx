...
const Pseudonym = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-28 sm:pb-12">
      ...
      <main className="container mx-auto max-w-3xl px-3 sm:px-4 py-4 sm:py-8">
        <div className="text-center mb-6 sm:mb-8">
          <div className="mx-auto inline-flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-teal-light">
            <Mic2 className="h-5 w-5 sm:h-6 sm:w-6 text-accent" />
          </div>
