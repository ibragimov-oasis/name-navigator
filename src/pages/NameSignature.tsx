    ...
    <div className="min-h-screen bg-background pb-28 sm:pb-12">
      ...
      <div className="container mx-auto max-w-4xl px-3 sm:px-4 py-4 sm:py-8">
        <div className="text-center mb-6">
          <Pen className="mx-auto h-8 w-8 sm:h-10 sm:w-10 text-primary" />
          <h1 className="mt-2.5 font-display text-2xl sm:text-3xl font-bold text-foreground">Генератор подписей</h1>
          <p className="mt-1 text-xs sm:text-sm text-muted-foreground">Реалистичные подписи с имитацией пера — 8 уникальных стилей</p>
        </div>
