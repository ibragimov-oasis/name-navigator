...
// Retro-TV "NOT FOUND" 404. Design inspired by Stefan Devai (Dribbble).
// All styles are scoped under `.tv404` so they cannot collide with the app's
// global CSS, and the flicker keyframe is namespaced (`tv404b`).
const styles = `
.tv404{
  position: relative;
  min-height: 100vh;
...
.tv404 *, .tv404 *::before, .tv404 *::after { box-sizing: border-box; }
...
.tv404 .screen{
  ...
  background-blend-mode: difference;
  animation: tv404b 0.2s infinite alternate;
  border-radius: 10px;
  z-index: 99;
  display: flex;
  align-items: center;
...
.tv404 .screenM:before, .tv404 .screenM:after{
  content: "";
  position: absolute;
  left: 0;
  z-index: 1;
...
.tv404 .speakers .g1 .g11, .tv404 .g12, .tv404 .g13{
  width: 0.65em;
  height: 0.65em;
  border-radius: 50%;
  background-color: #7f5934;
...
.tv404 .text_4041{ transform: scaleY(24.5) scaleX(9); }
.tv404 .text_4042{ transform: scaleY(24.5) scaleX(9); }
.tv404 .text_4043{ transform: scaleY(24.5) scaleX(9); }
...
.tv404 .tv404-home:hover{ transform: translateY(-2px); }

@media only screen and (max-width: 495px){
  .tv404 .text_404{ column-gap: 6em; }
}
@media only screen and (max-width: 395px){
  .tv404 .text_404{ column-gap: 4em; }
  .tv404 .text_4041{ transform: scaleY(25) scaleX(8); }
  .tv404 .text_4042{ transform: scaleY(25) scaleX(8); }
  .tv404 .text_4043{ transform: scaleY(25) scaleX(8); }
}
@media (max-width: 275px), (max-height: 520px){
  .tv404 .main{ position: relative; }
}
@media only screen and (max-width: 1024px){
  .tv404 .screenM{ display: flex; }
  .tv404 .screen{ display: none; }
}
@media only screen and (min-width: 1025px){
  .tv404 .screen{ display: flex; }
  .tv404 .screenM{ display: none; }
}
`;
...
const NotFound = () => {
  ...
  return (
    <div className="tv404">
      ...
      <a className="tv404-home" href="/">Back to home</a>
    </div>
  );
};
