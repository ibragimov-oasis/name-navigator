...
export function getKnowledgeIndex(): RagDoc[] {
  ...
  const guides = [
    ...
    {
      id: "tajik-registry",
      title: "Реестр разрешённых имён Таджикистана (Феҳристи номҳои миллӣ)",
      body: "Официальный реестр национальных имён Республики Таджикистан (Қарори Ҳукумати ҶТ №98 аз 26.02.2026). Разрешённые имена для ЗАГС (САҲШ), проверка законности, транслитерация и выписки.",
      url: "/tajik-names",
      tags: ["таджикистан", "реестр", "разрешенные", "загс", "сахш", "фехрист", "таджикские"],
    },
  ];
